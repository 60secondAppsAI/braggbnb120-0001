						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  ...
								  <base-input label="ProfilePicture" type="text" placeholder="Enter ProfilePicture" v-model="userToAdd.profilePicture"></base-input>
								  <base-input label="About" type="text" placeholder="Enter About" v-model="userToAdd.about"></base-input>
												                  </form>
								                </div>
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Phone Number</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Profile Picture</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="ProfilePicture" type="text" placeholder="Enter ProfilePicture" v-model="userDetails.profilePicture"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">About</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="About" type="text" placeholder="Enter About" v-model="userDetails.about"></input>
																		</div>
						</td>
														</tr>
