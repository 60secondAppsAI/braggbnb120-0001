						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  ...
								  <base-input label="Subject" type="text" placeholder="Enter Subject" v-model="messageToAdd.subject"></base-input>
            ...
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Subject</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Subject" type="text" placeholder="Enter Subject" v-model="messageDetails.subject"></input>
																		</div>
						</td>
														</tr>
															<tr> 
